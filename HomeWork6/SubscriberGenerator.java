...
public class SubscriberGenerator {
    public static Subscriber[] getSubArrayArray(){
        ...
        Subscriber[] subs = new Subscriber[10];
            Subscriber subs1 = new Subscriber(1, "Lobanov", "Andrey", "Olegovich", "Kyiv", "380954476588", "#12", 3500, 1500, 1000, "∞");
            ...
            Subscriber subs7 = new Subscriber(7, "Semenyouk", "Alexsandr", "Petrivich", "Odessa", "380938759081", "#3", 1600, 400,200, "3500mb");
            ...
            Subscriber subs10 = new Subscriber(10, "Maxno", "Alisa", "Batikovna", "Kharkiv", "380977472589", "#13", 4000, 2000,1500, "∞");
