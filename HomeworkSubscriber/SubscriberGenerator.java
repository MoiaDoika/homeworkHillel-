...
public class SubscriberGenerator{
    public static ArrayList<Subscriber> getSubscriber(){
        ...
        Subscriber subs1 = new Subscriber(1, "Lobanov", "Andrey", "Olegovich", "Kyiv", "380954476588", "#12", -300, 1500, 0, 32424);
        ...
        Subscriber subs9 = new Subscriber(9, "Senko", "Ivan", "Ivanivich", "Dnipro", "380637834599", "#4", -350, 1200,750, 32344);
